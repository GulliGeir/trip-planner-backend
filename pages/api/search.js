...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (includeFlights) {
      const flightUrl = `https://api.travelpayouts.com/v1/prices/cheap?origin=${origin}&destination=KEF&depart_date=${departureDate}&return_date=${returnDate}&token=YOUR_TRAVELPAYOUTS_TOKEN`;
